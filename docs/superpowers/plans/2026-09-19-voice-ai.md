...
**Goal:** Ship Trail's voice/AI workstream: narration capture, timestamped transcription plus validated segment labels, and a GPT-Live-1 voice coach with a text fallback, all testable on a laptop in mock mode.
