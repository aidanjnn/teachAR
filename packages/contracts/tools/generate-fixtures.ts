...
save('starting-layout',{schemaVersion:1,recordingId:recording.id,recordingHash:hash,tutorialId:tutorial.id,tutorialRevision:tutorial.revision,assetId:'synthetic-layout-image',source:'quest-camera',frameIndex:0,notes:'Synthetic setup: place the block left of the mat.'});
save('starting-layout-edit',{baseRevision:1,assetId:'synthetic-layout-image',notes:'Synthetic setup: place the block left of the mat.'});
...
bad('StartingLayout','starting-layout','layout frame outside recording limit',['frameIndex'],3600);
bad('StartingLayout','starting-layout','layout missing notes',['notes'],'');
bad('StartingLayout','starting-layout','layout unsupported source',['source'],'synthetic');
bad('StartingLayoutEdit','starting-layout-edit','layout edit negative revision',['baseRevision'],-1);
save('corpus',{cases});
