...
const enums = {
  ...
  phase: ['idle', 'demo_preview', 'ready', 'following', 'user_paused', 'tracking_lost', 'system_wait', 'checkpoint', 'hidden'],
  ...
  mode: ['home', 'loading-library', 'library', 'save-home', 'setup-new', 'setup-follow', 'start', 'end', 'placement', 'adjust-placement', 'author', 'author-options', 'capture', 'capture-paused', 'confirm-discard', 'saving', 'saving-tutorial', 'review-step', 'review-options', 'saved', 'learn', 'learn-options', 'finished', 'settings', 'trim', 'boundary-help', 'confirm-home', 'confirm-exit', 'media-setup', 'media-wait', 'unknown'],
  control: ['none', 'create', 'library', 'edit-current', 'open-tutorial', 'library-prev', 'library-next', 'home', 'set-save-position', 'cancel-save-position', 'setup-ready', 'primary', 'redo-placement', 'placement-ready', 'adjust-placement', 'shift-left', 'shift-right', 'shift-away', 'shift-near', 'rotate-placement', 'placement-back', 'hand', 'clear', 'author-options', 'toggle-clean', 'change-save-position', 'capture-reference', 'author-back', 'replay', 'removeCue', 'discard-confirm', 'discard-take', 'keep-take', 'guide-hands', 'review-options', 'verify', 'cue', 'review-back', 'start-follow', 'try-follow', 'watch-demo', 'learn-options', 'restart-follow', 'move-tutorial', 'learn-back', 'retry-save', 'panel-place', 'exit', 'enter-ar', 'settings', 'settings-back', 'theme', 'sound', 'boundary-help', 'help-back', 'home-save', 'home-discard', 'exit-discard', 'library-item', 'library-search', 'library-clear', 'library-filter', 'library-page-prev', 'library-page-next', 'media-enable', 'media-skip', 'capture-hands', 'toggle-fluid', 'fluid-stop', 'review-pause', 'keep-add', 'trim-open', 'trim-start-less', 'trim-start-more', 'trim-end-less', 'trim-end-more', 'trim-apply', 'trim-cancel', 'coach-ask'],
};
