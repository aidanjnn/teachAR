...
export class SpatialControls {
 ...
 tick(time,viewer){
  ...
  c.clearRect(0,0,768,256);c.fillStyle=p.surface;c.beginPath();c.roundRect(0,0,768,256,36);c.fill();c.fillStyle=p.muted;c.font='24px system-ui';c.fillText('TeachAR · PINCH TO MOVE',32,42);
