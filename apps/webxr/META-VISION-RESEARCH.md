> Historical research from the earlier prototype. Native platform examples are not dependencies or implementation instructions for the current [WebXR foundation](../../docs/plan.md).
