...
if __name__=="__main__":
    ...
    print(f"Plushie tester: http://localhost:{port}\nQuest camera: http://localhost:{port}/camera\nLocal vision + optional manual AI checks (100-attempt cap). Ctrl-C to stop.",flush=True)
    try:
