...
integration targets. The [standalone UI reference][ui-reference] remains simulated;
its connected DOM/XR implementation is described in [the UI base](docs/web-ui-base.md).
